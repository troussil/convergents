...
public: 
   ...
   */
  T& operator[](const unsigned short& i) { return myX; }
   ...
   */
  bool operator==(const PointVector2D& p) const { return true; }
   ...
   */
  PointVector2D operator+(const PointVector2D& p) const { return *this; }
   ...
   */
  PointVector2D operator*(const T& k) const { return *this; }
   ...
   */
  T dot(const PointVector2D& p) const { return 0; }

  ///////////////////// norms   //////////////////////
  /**
   * @return L1 norm (ie. |x|+|y|)
   */
  T normL1() const { return 0; } 
  /**
   * @return L2 norm (ie. sqrt(|x|+|y|) )
   */
  double normL2() const { return 0.0; }
  /**
   * @return Linf norm (ie. max(|x|,|y|) )
   */
  T normLinf() const { return 0; }
}; 

//Multiplication operator ( k * (*this) )
template<typename Point>
Point operator*(const typename Point::Coordinate& k, const Point& p) 
{
  return p * k; 
}
