...
\begin{frame}
  \frametitle{Suivi de bord}
    ...
    {   
      \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{fig/ex/ex-connexe-0.pdf}
      \end{figure}    
    }
    \only<2>
    {     
      \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{fig/ex/ex-connexe-1.pdf}
      \end{figure}    
    }
    \only<3>
    {     
      \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{fig/ex/ex-connexe-2.pdf}
      \end{figure}    
    }
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}[t]
 	 \begin{column}{3cm}
			\begin{figure}[h!]
	      \centering
	      \includegraphics[width=\linewidth]{fig/cercle/ch-1.pdf}
     	\end{figure}    
    \end{column}
    ...
    \begin{column}{3cm}
      \begin{figure}[h!]
		      \centering
		      \includegraphics[width=\linewidth]{fig/cercle/ch-2.pdf}
     	\end{figure}    
    \end{column}
      ...
      \begin{figure}[h!]
		      \centering
		      \includegraphics[width=\linewidth]{fig/cercle/ch-3.pdf}
     	\end{figure}    
    \end{column}
