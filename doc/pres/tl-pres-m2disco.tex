...
\begin{frame}
  ...
  \only<1>
  {
    \begin{block}{Équation cartésienne du disque Eucliden}
      $$\mathcal{D} =  \left\{ (x,y) \in \mathbb{R}^{2} |  ax + by + c(x^2 + y^2) + d \leq 0. \right\}$$
    \end{block}
  }
  \only<2->
  {
    \begin{block}{Équation cartésienne du disque discret}
...
\frametitle{Les $\alpha$-shape}
  ...
  utilisation d'alpha-shape pour récuperer les bords 4 / 8 connexes, l'enveloppe convexe\\
  superposition -> delaunay...
