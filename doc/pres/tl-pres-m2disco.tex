...
\begin{exampleblock}{}
\begin{itemize}
\item Permet le calcul exact en évitant tous les problèmes d'approximations et d'arrondis.
...
\item Mais des calculs différents et souvent icompatibles entre eux.
\end{block}
\end{column}
\end{columns}  
\end{frame}
