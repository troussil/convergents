...
En définissant les points du bord du disque discrèt comme l'ensemble des points appartenant au disque dont le 4-voisinage n'est pas intégralement contenu dans le disque, on définit un ensemble 8-connexes alors que respectivement en choisissant un 8-voisinage, on obtient un ensemble 4-connexe.
