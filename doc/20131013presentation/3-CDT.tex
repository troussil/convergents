...
% ----------------------------------------------------------------------
\begin{frame}
  	\frametitle{Schéma de preuve}

%EMST in CDT
\begin{block}{1. L'EMST divise la CDT en deux parties} 
\centering
...
\begin{block}{2. La partie supérieure de l'enveloppe convexe se triangule de manière unique} 
\only<1>{
\begin{figure}[htbp]
\centering
...
\begin{block}{Calcul incrémental et \emph{output-sensitive} 
...
\begin{block}{Généralisation pour $\alpha \leq 0$}
%explications orales ?
 \begin{itemize}
  \item raffinement récursif à partir des arêtes de l'enveloppe convexe
  \item calcul incrémental à partir des convergents des arêtes
 \end{itemize}
